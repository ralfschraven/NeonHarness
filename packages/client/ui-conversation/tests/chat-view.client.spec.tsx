...
describe('ChatView', () => {
  it('keeps a windowless tool result out of the Chat transcript', () => {
    const h = makeHarness({
  ...
  it('renders the fixture transcript without operational process rows', () => {
    const h = makeHarness({
    ...
    expect([...view.container.querySelectorAll('[data-chat-anchor-key]')].map(row => row.getAttribute('data-chat-anchor-key')))
      .toEqual(['fixture:user:1', 'fixture:assistant:2'])
  })
